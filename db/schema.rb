...
ActiveRecord::Schema.define(version: 2022_05_03_032817) do
  ...
  create_table "personal_pages", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "player_id"
    t.index ["player_id"], name: "index_personal_pages_on_player_id"
  end
  ...
  create_table "players", force: :cascade do |t|
    ...
    t.integer "player_rank", default: 0
    t.integer "player_wins", default: 0
    t.integer "player_loses", default: 0
  ...
  add_foreign_key "personal_pages", "players"
end
